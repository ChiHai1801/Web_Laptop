                                    ...
                                    ?>
                                        <tr class="cart_item ">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.php?product_id=<?php echo $cart[$i]['id'] ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo 'admin/pages/laptop/uploads/' . $listImg[0]['img'] ?>"></a>
                                            </td>
