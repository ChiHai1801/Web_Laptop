...
switch ($actual_link) {
  case '/localhost/laptop/index.php':
    $_SESSION['title'] = 'Shop Laptop';
    break;
  case '/laptop/lap_gaming.php':
    $_SESSION['title'] = 'Lap_gaming';
    break;
  case '/laptop/TTusers.php':
    $_SESSION['title'] = 'Thông tin người dùng';
    break;
  case '/laptop/cart.php':
    $_SESSION['title'] = 'Giỏ Hàng Của Bạn';
    break;
  case '/laptop/thuonghieu.php':
...
<body class="page">
    ...
    <a href="#" class="brand-link">
        ...
        <div class="button__login-register">
            <a class="bt button__register"   href="./register.php">Signup</a>
            <a class="bt button__login"  href="./login.php" >Login</a>
        ...
        <nav class="header__nav"> 
            ...
            <div class="nav__link">
              ...
              <a class="nav__link--items"  href="./TrangTT_SP/index.php" class="menu-bth">Thông tin sản phẩm</a>
