...
?>
    <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $_GET['idsanpham'] ?>" enctype="multipart/form-data">
        ...
        <tr>
         <td>Tóm tắt</td>
         <td><textarea rows="10" type="text" name="tomtat" style="resize: none"><?php echo $row['tomtat'] ?></textarea></td>
       </tr>

        <tr>
          <td>Nội dung</td>
          <td><textarea rows="10" type="text" name="noidung" style="resize: none"><?php echo $row['noidung'] ?></textarea></td>
        </tr>
